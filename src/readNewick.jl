...
function readNewick(args...;filepath::ASCIIString="", format="nwk")
    ...
    tip_label = AbstractString[];  # generate empty tip_label vector
    # tip_label = Array{ASCIIString,1};    # set up the type 
